export const metadata = {
  title:
    'Setting Up a Next.js Project with Tailwind CSS, TypeScript, and Advanced Tooling',
  description:
    'A step-by-step guide to setting up a modern Next.js project with TypeScript, Tailwind CSS, and advanced tooling including ESLint, Prettier, Commitlint, and more. Learn how to create a robust development environment with automated code formatting, linting, and commit message validation.',
  tags: 'Next.js, TypeScript, Tailwind CSS, ESLint, Prettier, Commitlint, Lint-staged, Simple Git Hooks, Turbopack, Shadcn, Web Development, JavaScript, Frontend',
}
