...
- And even React documentation recommends it first before anything else. Don't believe me? See for yourself: [Starting with React](https://react.dev/learn/start-a-new-react-project)
