...
- Hooks (the first 7-15 seconds of the video, the less the better) are the most important part of the video, it is what makes or breaks the video.
...
So if we were starting today - ho would we do it?
